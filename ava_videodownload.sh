...
# Base URL of the videos
trainval_url="https://s3.amazonaws.com/ava-dataset/trainval/"
test_url="https://s3.amazonaws.com/ava-dataset/test/"

# Create a directory to store the downloaded files
mkdir -p trainval_downloaded_videos
mkdir -p test_downloaded_videos

# List of video file names
trainval_video_files=(
"_-Z6wFjXtGQ.mkv"
"_145Aa_xkuE.mp4"
"_7oWZq_s_Sk.mkv"
"_a9SWtcaNj8.mkv"
...
for file_name in "${trainval_video_files[@]}"; do
  # Construct the complete URL
  trainvalurl="${trainval_url}${file_name}"
  
  # Download the video using wget
  wget -P trainval_downloaded_videos "$trainvalurl"
done
...
for file_name in "${test_video_files[@]}"; do
  # Construct the complete URL
  testurl="${test_url}${file_name}"
  
  # Download the video using wget
  wget -P test_downloaded_videos "$testurl"
done
